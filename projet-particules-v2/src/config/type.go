...
type Config struct {
	...
	OpacityVariation         bool
	ParticleRotationSpeed    float64
	RotorSpeed               uint
	Gravity                  float64
	DrawOblivionMargin       float64
	DeathTime                float64
	RightClickSpawning       bool
	LeftClickMovesSpawner    bool
	EnableColors             bool
	EnableLeftClickSound     bool
	EnableRightClickSound    bool
	MemoryThanksYou          bool
